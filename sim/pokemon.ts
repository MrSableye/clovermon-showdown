	...
	*/
	...
	ignoringAbility() {
		...
		for (const pokemon of this.battle.getAllActive()) {
			...
			if (pokemon.ability === ('neutralizinggas' as ID) && !pokemon.volatiles['gastroacid'] && this.battle.field.pseudoWeather['genwunning'] && 
		...
		return !!(
			...
			((this.volatiles['gastroacid'] || (neutralizinggas && this.ability !== ('neutralizinggas' as ID)) || this.battle.field.pseudoWeather['genwunning'])  &&
