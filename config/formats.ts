...
export const Formats: FormatList = [
	...
	},
	{
		...
		banlist: ['Uber', 'Arena Trap', 'Moody', 'Power Construct', 'Shadow Tag', 'Baton Pass', 'Wonder Guard', 'Inversion', 'Sand Veil', 'Shell Smash + Molterra','Ultraposition','Ignite'],
		unbanlist: [
		    ...
		    'Bitter Blade','Fragile','Ignite','Death Throes'], 
	},
	{
