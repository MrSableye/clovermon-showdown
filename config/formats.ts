...
export const Formats: FormatList = [
	...
	},
	{
		...
		banlist: ['Baton Pass', 'Nothing', 'Moody', 'Arena Trap', 'Shadow Tag', 'Autumn', 'Doomsday', 'Doomsday-Revenant', 'Fusjite', 'Eternatus-Eternamax', 'Fuck You', 'Eternal Walk', 'Cope', 'Francine', "It's Over"],
	},
	{
		name: "[Gen 1] Ubers",
		mod: 'gen1',
