	...
	},
{
	...
	{
		name: '[Gen 8 Clover Blobbos Draft Only] Ubers',
		mod: 'cloverblobboscap',
		ruleset: [
			'Terastal Clause',
			'Obtainable',
		...
		banlist: ['Baton Pass', 'Moody', 'Mating Press', 'Loaded Disk', 'Banana', 'Mating Press', 'Sexite Y', 'Nimble Metal Body', 'Arena Trap', 'Shadow Tag', 'Fling + License to Sell Hotdogs', 'Mitosis Mash', 'Cell Construct', 'Power Herb + Geomancy', 'Huge Power + Blobbos-Chad', 'Pure Power + Blobbos-Chad', 'Power Herb + Awaken', 'Baitite + Destiny Bond', 'Star Rod + Victory Dance', 'Blobbos-Zero', 'Blobbos-Arceus', 'Blobbos-Clover', 'Blobbos-Dark Matter', 'Blobbos-Forbidden', 'Blobbos-Horse', 'Blobbos-Primal', "Partner's Pendant + Super Snore"],
	},
	{
