...
export const Formats: FormatList = [
	...
	},
	{
		...
		unbanlist: [
			'Ginoccite', 'Ginocchio-Mega', 'Salezerkite', 'Salezerker-Mega','Lemirethun-Mega', 'Lemirethite','Platylics-Mega','Platylicite','Glucurs-Mega','Glucusite','Camerex-Mega','Camerite','Konekoth-Mega','Konekothite','Molterra-Mega-X','Molterrite X','Shroomalicite','Shroomalice-Mega','Zillichinite','Zillichina-Mega','Sepulturite','Sepulture-Mega','Molterra-Mega-Y','Molterrite Y','Sacrifleece','Auculus','Stallter','Cotstall','Wyndvyrm','Garerowl','Corperial','Stanchagram','Gunflyre','Arcridget','Gem','Azumarite','Wyldhaunt','Wyldhaunt-Dullahan','Requiem Rend'],
	},
	{
