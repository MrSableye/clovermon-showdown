...
export const Moves: {[moveid: string]: MoveData} = {
  ...
  mop: {
    ...
    basePower: 0,
    category: "Status",
		name: "Mop (IN-PROGRESS)",
		desc: "The user cleans up hazards on its side for free.",
    pp: 10,
    priority: 0,
    target: "normal",
    type: "Fairy",
		flags: {contact: 1, protect: 1, mirror: 1, punch: 1},
		// TODO: Implement mechanic LOL
  },
  quicksand: {
    num: 69037,
    accuracy: 100,
    ...
    category: "Physical",
		name: "Quick Sand",
		desc: "The user quickly digs up clumpy sand at the foe.",
    pp: 20,
    priority: 1,
    target: "normal",
		type: "Ground",
  ...
  thinkfast: {
    ...
    category: "Special",
		name: "Think Fast",
		desc: "The user quickly thinks up a weak psychic attack.",
    pp: 20,
    priority: 1,
    target: "normal",
    type: "Psychic",
  ...
  boltbeam: {
    ...
    category: "Special",
		name: "Boltbeam",
		desc: "The user combines the power of ice and electricity into a single attack.",
    pp: 10,
    priority: 0,
    target: "normal",
		type: "Electric",
  ...
  checkem: {
    ...
    category: "Special",
		name: "Check 'Em",
		desc: "A multi-hit move with damage based on the highest attacking stat.",
    pp: 15,
    priority: 0,
    target: "normal",
    type: "Psychic",
  ...
  pixiepummel: {
    ...
    category: "Physical",
		name: "Pixie Pummel",
		desc: "Pummels the foe with the power of mythical proportions.",
    pp: 5,
    priority: 0,
    target: "normal",
    type: "Fairy",
  ...
  gayagenda: {
    ...
    category: "Status",
		name: "Gay Agenda",
		desc: "Coerces the foe to fall in love with the same gender using mind control.",
    pp: 15,
    priority: 0,
    target: "normal",
    type: "Fairy",
  ...
  spooperpower: {
    ...
    category: "Special",
		name: "Spooperpower",
		desc: "This move inflicts damage based on the user's highest attacking stat.",
    pp: 5,
    priority: 0,
    target: "normal",
    type: "Ghost",
  ...
  greatrage: {
    ...
    category: "Physical",
		name: "Great Rage",
		desc: "The user yells out in frustration, influencing nature itself to attack",
    pp: 10,
    priority: 0,
    target: "normal",
    type: "Grass",
  ...
  wowwiener: {
    ...
    category: "Special",
		name: "Wow Wiener",
		desc: "Wieners fly at the target 2-5 times.",
    pp: 15,
    priority: 0,
    target: "normal",
    type: "Fire",
  ...
  plunder: {
    ...
    category: "Physical",
		name: "Plunder",
		desc: "The user bashes and slashes the foe, also stealing its held item.",
    pp: 5,
    priority: 0,
    target: "normal",
    type: "Water",
  ...
  blobbybop: {
    ...
    category: "Physical",
		name: "Blobby Bop",
		desc: "Blobbos bounces at the foe with an unavoidable icy power.",
    pp: 15,
    priority: 0,
    target: "normal",
    type: "Ice",
  ...
  banhammer: {
    ...
    category: "Physical",
		name: "Ban Hammer",
		desc: "The user exacts its arbitrary sense of justice, also tormenting the foe.",
    pp: 10,
    priority: 0,
    target: "normal",
    type: "Normal",
  ...
  homerunbat: {
    ...
    category: "Physical",
		name: "Homerun Bat",
		desc: "Takes aim and hits the foe with a home run, forcing them to switch.",
    pp: 10,
    priority: -6,
    target: "normal",
    type: "Normal",
  ...
  elbowdrop: {
    ...
    category: "Physical",
		name: "Elbow Drop",
		desc: "A legendary finishing move developed through years of dedication.",
    pp: 5,
    priority: 0,
    target: "normal",
    type: "Ghost",
