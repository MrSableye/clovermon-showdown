...
export const Moves: {[moveid: string]: MoveData} = {
  ...
  fruitpunch: {
    ...
    category: "Physical",
		name: "Fruit Punch",
		desc: "An effeminate punch that may also lower the foe's Defense.",
    pp: 15,
    priority: 0,
    target: "normal",
		type: "Fairy",
  ...
  dragonfist: {
    ...
    category: "Physical",
		name: "Dragon Fist",
		desc: "A dragon-ish punch with epic dragon power that may paralyze the foe.",
    pp: 15,
    priority: 0,
    target: "normal",
		type: "Dragon",
  ...
  speedweed: {
    ...
    category: "Physical",
		name: "Speed Weed",
		desc: "DUDE. WEED. LMAO. Does damage fast.",
    pp: 30,
    priority: 1,
    target: "normal",
    type: "Grass",
  ...
  overbite: {
    ...
    category: "Physical",
		name: "Overbite",
		desc: "Inflicts damage to self equal to half of total HP.",
    pp: 5,
    priority: 0,
    target: "normal",
		type: "Dark",
  ...
  warhead: {
    ...
    category: "Special",
		name: "Warhead",
		desc: "The user simulates conductive rails to fire a powerful blast.",
    pp: 5,
    priority: 0,
    target: "normal",
    type: "Steel",
  ...
  hulkup: {
    ...
    category: "Status",
		name: "Hulk Up",
		desc: "Boosts attack and defense. Boosts it sharply if under half health, brother.",
    pp: 10,
    priority: 0,
    target: "self",
		type: "Fighting",
  ...
  focusmunch: {
    ...
    category: "Status",
		name: "Focus Munch",
		desc: "Heals and raises accuracy but only if the user can focus.",
    pp: 10,
    priority: -3,
    target: "self",
    type: "Fighting",
