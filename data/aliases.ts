export const Aliases: {[alias: string]: string} = {
	...
	// Blobbos CAP Aliases
	attorney: "Blobbos-Attorney",
	adventurer: "Blobbos-Adventurer",
	angel: "Blobbos-Angel",
	alola: "Blobbos-Alola",
	jod: "Blobbos-Arceus",
	hitler: "Blobbos-Artist",
	athlete: "Blobbos-Athlete",
	adventurerl: "Blobbos-Adventurer-Legendary",
	adventurerlegendary: "Blobbos-Adventurer-Legendary",
	ayylien: "Blobbos-Ayylien",
	bait: "Blobbos-Bait",
	baitmega: "Blobbos-Bait-Mega",
	beetle: "Blobbos-Beetle",
	buzzlos: "Blobbos-Bee",
	bintles: "Blobbos-Bee",
	birb: "Blobbos-Birb",
	bloody: "Blobbos-Bloody",
	caca: "Blobbos-Caca",
	calamity: "Blobbos-Calamity",
	crabulon: "Blobbos-Calamity",
	candycorn: "Blobbos-Candycorn",
	cap: "Blobbos-Cap",
	cell: "Blobbos-Cell",
	c3ll: "Blobbos-Cell",
	chad: "Blobbos-Chad",
	chainsaw: "Blobbos-Chainsaw",
	pochita: "Blobbos-Chainsaw",
	chef: "Blobbos-Chef",
	classy: "Blobbos-Classy",
	clause: "Blobbos-Clause",
	cloud: "Blobbos-Cloud",
	creature: "Blobbos-Creature",
	cup: "Blobbos-Cup",
	dalle: "Blobbos-DALL-E",
	delinquent: "Blobbos-Delinquent",
	jojo: "Blobbos-Delinquent",
	demifiend: "Blobbos-Demifiend",
	smt: "Blobbos-Demifiend",
	demon: "Blobbos-Demon",
	devil: "Blobbos-Devil",
	doctor: "Blobbos-Doctor",
	doll: "Blobbos-Doll",
	dollp: "Blobbos-Doll-Possessed",
	dollpossessed: "Blobbos-Doll-Possessed",
	double: "Blobbos-Double",
	drowned: "Blobbos-Drowned",
	ben: "Blobbos-Drowned",
	dust: "Blobbos-Dust",
	eggdog: "Blobbos-Eggdog",
	blunderbolt: "Blobbos-Electric",
	engineer: "Blobbos-Engineer",
	exe: "Blobbos-Exe",
	eye: "Blobbos-Eye",
	firefighter: "Blobbos-Firefighter",
	fish: "Blobbos-Fish",
	fnaf: "Blobbos-FNAF",
	wasthatthebiteof87: "Blobbos-FNAF",
	fools: "Blobbos-Fool's",
	fox: "Blobbos-Fox",
	galar: "Blobbos-Galar",
	galarc: "Blobbos-Galar-Crowned",
	galarcrowned: "Blobbos-Galar-Crowned",
	gay: "Blobbos-Gay",
	jean: "Blobbos-Gene",
	kaboom: "Blobbos-Explosion",
	kamina: "Blobbos-Drill",
	gigantamax: "Blobbos-Gigantamax",
	neigh: "Blobbos-Horse",
	gmax: "Blobbos-Gigantamax",
	glover: "Blobbos-Glover",
	ballbearing: "Blobbos-Glover-Ball-Bearing",
	bowlingball: "Blobbos-Glover-Bowling-Ball",
	crystalball: "Blobbos-Glover-Crystal-Ball",
	gnome: "Blobbos-Gnome",
	hat: "Blobbos-Hat",
	hc: "Blobbos-HARDCORE",
	henesys: "Blobbos-Henesys",
	hisui: "Blobbos-Hisui",
	hoenn: "Blobbos-Hoenn",
	hologram: "Blobbos-Hologram",
	homestuck: "Blobbos-Homestuck",
	horni: "Blobbos-Horni",
	diseased: "Blobbos-Infected",
	jackolantern: "Blobbos-Jack o' Lantern",
	jacko: "Blobbos-Jack o' Lantern",
	jannie: "Blobbos-Jannie",
	johto: "Blobbos-Johto",
	kaiju: "Blobbos-Kaiju",
	kalos: "Blobbos-Kalos",
	keks: "Blobbos-Keks",
	king: "Blobbos-King",
	kirbos: "Blobbos-Kirby",
	korea: "Blobbos-Korea",
	squidgames: "Blobbos-Korea",
	lambdal: "Blobbos-Lambdal",
	lawnmower: "Blobbos-Lawnmower",
	johndeere: "Blobbos-Lawnmower",
	magic: "Blobbos-Magic",
	plokgaming2006: "Blobbos-Plok",
	mnm: "Blobbos-M and M",
	mimirkyu: "Blobbos-Mimikyu",
	mentum: "Blobbos-Muhmentum",
	decayed: "Blobbos-Mummy",
	dowster2: "Blobbos-Nightmare",
	swamplos: "Blobbos-Swamp",
	darkmatter: "Blobbos-Dark Matter",
	eedle: "Blobbos-eedle",
	eedletrue: "Blobbos-eedle-True",
	zero: "Blobbos-Zero",
	zeromega: "Blobbos-Zero-Mega",
	"0mega": "Blobbos-Zero-Mega",
	marx: "Blobbos-Marx",
	mega: "Blobbos-Mega",
	mk: "Blobbos-Meta Knight",
	metal: "Blobbos-Metal",
	mexican: "Blobbos-Mexican",
	midjourney: "Blobbos-Midjourney",
	mini: "Blobbos-Mini",
	moniker: "Blobbos-Moniker",
	mountain: "Blobbos-Mountain",
	muhpalms: "Blobbos-Muhpalms",
	mushroom: "Blobbos-Mushroom",
	nega: "Blobbos-Nega",
	negat: "Blobbos-Nega-Tandor",
	negatandor: "Blobbos-Nega-Tandor",
	nice: "Blobbos-Nice",
	woodman: "Blobbos-Nice",
	ninja: "Blobbos-Ninja",
	noice: "Blobbos-Noice",
	noke: "Blobbos-Noke",
	ocean: "Blobbos-Ocean",
	onions: "Blobbos-Ogre",
	omori: "Blobbos-Omori",
	orangeisles: "Blobbos-Orange-Isles",
	oi: "Blobbos-Orange-Isles",
	paldea: "Blobbos-Paldea",
	paper: "Blobbos-Paper",
	peri: "Blobbos-Peri",
	bika: "Blobbos-Pika",
	pirate: "Blobbos-Pirate",
	pizza: "Blobbos-Pizza",
	plok: "Blobbos-Plok",
	postmodern: "Blobbos-Postmodern",
	shitbox: "Blobbos-Present",
	primal: "Blobbos-Primal",
	rembered: "Blobbos-Rembered",
	retro: "Blobbos-Retro",
	genwun: "Blobbos-Retro",
	reverse: "Blobbos-Reverse",
	reversemega: "Blobbos-Reverse-Mega",
	robotnik: "Blobbos-Robotnik",
	salt: "Blobbos-Salt",
	sexy: "Blobbos-Sexy",
	sex: "Blobbos-Sexy",
	megasex: "Blobbos-Sexy-Mega-Y",
	sexymegax: "Blobbos-Sexy-Mega-Y",
	sexymegay: "Blobbos-Sexy-Mega-Y",
	sex2: "Blobbos-Sexy-Mega-Y",
	shadow: "Blobbos-Shadow",
	shining: "Blobbos-Shining",
	shoreline: "Blobbos-Shoreline",
	shrimp: "Blobbos-Shrimp",
	srimp: "Blobbos-Shrimp",
	sinnoh: "Blobbos-Sinnoh",
	skelos: "Blobbos-Skeleton",
	slepp: "Blobbos-Slepp",
	sneed: "Blobbos-Sneed",
	snek: "Blobbos-Snek",
	snowblos: "Blobbos-Snowman",
	spamton: "Blobbos-Spamton",
	speen: "Blobbos-Speen",
	spooky: "Blobbos-Spooky",
	starfy: "Blobbos-Starfy",
	monstar: "Blobbos-Starfy-Monstar",
	roostar: "Blobbos-Starfy-Roostar",
	starfright: "Blobbos-Starfy-Starfright",
	starpedo: "Blobbos-Starfy-Starpedo",
	strand: "Blobbos-Strand",
	hideokojima: "Blobbos-Strand",
	hideokojimainventorofthehideogame: "Blobbos-Strand",
	surfer: "Blobbos-Surfer",
	sus: "Blobbos-Sus",
	amongus: "Blobbos-Sus",
	switch: "Blobbos-Switch",
	switchred: "Blobbos-Switch-Red",
	switchr: "Blobbos-Switch-Red",
	switchblue: "Blobbos-Switch-Blue",
	switchb: "Blobbos-Switch-Blue",
	marsh: "Blobbos-Swamp",
	tandor: "Blobbos-Tandor",
	trap: "Blobbos-Trap",
	astolfo: "Blobbos-Trap",
	triple: "Blobbos-Triple",
	triplos: "Blobbos-Triple",
	ue: "Blobbos-UE",
	ui: "Blobbos-UI",
	ultra: "Blobbos-Ultra",
	unova: "Blobbos-Unova",
	valian: "Blobbos-Valian",
	vampire: "Blobbos-Vampire",
	viol: "Blobbos-Viol",
	volcano: "Blobbos-Volcano",
	wacklos: "Blobbos-Wack",
	megawacklos: "Blobbos-Wack-Mega",
	zombielos: "Blobbos-Zombie",
	fake: "Bootlos",
	faker: "Bootlos",
	chameleon: "Blobbos-Chameleon",
	forbidden: "Blobbos-Forbidden",
	fossil: "Blobbos-Fossil",
	nut: "Blobbos-Nut",
	obese: "Blobbos-Obese",
	fatass: "Blobbos-Obese",
	convergent: "Blobbos-Convergent",
	frug: "Blobbos-Convergent",
	cherry: "Blobbos-Cherry",
	idiot: "Blobbos-Idiot",
	artiffy: "Blobbos-Artiffy",
	fallen: "Blobbos-Fallen",
	slug: "Blobbos-Slug",
