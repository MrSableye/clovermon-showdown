export const MovesText: {[k: string]: ModdedMoveText} = {
	...
	seedbomb: {
		inherit: true,
		desc: "If the user is a Grass-type, has a 1/16 chance to apply Leech Seeds.",
		shortDesc: "Grass-type users have a 1/16 chance to Leech Seed.",
	},
	spikecannon: {
		inherit: true,
		desc: "Has a 1/8 chance to set spikes per hit.",
