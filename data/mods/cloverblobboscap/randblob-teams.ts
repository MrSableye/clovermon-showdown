...
const RECOVERY_MOVES = [
	'healorder', 'milkdrink', 'moonlight', 'morningsun', 'recover', 'roost', 'shoreup', 'slackoff', 'softboiled', 'strengthsap', 'synthesis', 'anyheal',
];
...
const PHYSICAL_SETUP = [
	'bellydrum', 'bulkup', 'coil', 'curse', 'dragondance', 'honeclaws', 'howl', 'meditate', 'poweruppunch', 'swordsdance', 'tidyup', 'victorydance', 'anystatup',
];
// Moves which boost Special Attack:
const SPECIAL_SETUP = [
	'calmmind', 'chargebeam', 'geomancy', 'nastyplot', 'quiverdance', 'tailglow', 'torchsong', 'anystatup',
];
// Moves that boost Attack AND Special Attack:
const MIXED_SETUP = [
	'clangoroussoul', 'growth', 'happyhour', 'holdhands', 'noretreat', 'shellsmash', 'workup', 'anystatup',
];
...
const SETUP = [
	...
	'rockpolish', 'shellsmash', 'shiftgear', 'swordsdance', 'tailglow', 'tidyup', 'trailblaze', 'workup', 'victorydance', 'anystatup',
];
const SPEED_CONTROL = [
...
const PROTECT_MOVES = [
	'banefulbunker', 'protect', 'spikyshield', 'roidflex',
];
// Moves that switch the user out
const PIVOT_MOVES = [
	'chillyreception', 'flipturn', 'partingshot', 'shedtail', 'teleport', 'uturn', 'voltswitch', 'abduction', 
];
...
const NO_LEAD_POKEMON = [
	'blobboschroma', 'blobbosmummy', 'blobbospaldea', 'blobbosremembered', 'blobbosking', 'blobbospartner',
];
...
export class RandomTeams {
	...
	randomSets: {[species: string]: RandomTeamsTypes.RandomSpeciesData} = require('../blobbos-sets.json');
