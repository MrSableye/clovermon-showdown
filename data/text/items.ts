export const ItemsText: {[k: string]: ItemText} = {
	...
	zillichinite: {
		name: "Zillichinite",
		desc: "If held by a Zillichina, this item allows it to Mega Evolve in battle.",
	},
	sepulturite: {
		name: "Sepulturite",
		desc: "If held by a Sepulture, this item allows it to Mega Evolve in battle.",
	},
	colombite: {
		name: "Colombite",
		desc: "If held by a Colombite, this item allows it to Mega Evolve in battle.",
	},
	focusspecs: {
		name: "Focus Specs",
