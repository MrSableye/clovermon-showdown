export const AbilitiesText: {[k: string]: AbilityText} = {
	...
	eyeofblobbos: {
		name: "Eye of Blobbos",
		shortDesc: "If Blobbos-Eye, at end of the turn, changes to Eye-Mouth mode if not full HP.",
	...
	legendary: {
		...
		shortDesc: "Cannot be statused, Clear Body, x1.5 BP vs Dark/Dragon, Heroic Strike -> Heroic Onslaught.",
	},
	copypower: {
		name: "Copy Power",
