export const Pokedex: { [speciesid: string]: SpeciesData } = {
	...
	blobbosgalarcrowned: {
		...
		types: ["Steel", "Poison"],
		gender: "N",
		baseStats: {hp: 92, atk: 110, def: 82, spa: 110, spd: 81, spe: 75},
		abilities: {
			0: "Neutralizing Gas",
			1: "Power Spot",
			H: "Stalwart",
	...
	blobboskalos: {
		...
		forme: "Kalos",
		types: ["Fire", "Fairy"],
		baseStats: {hp: 72, atk: 69, def: 65, spa: 74, spd: 75, spe: 72},
	...
	blobbosmega: {
		...
		forme: "Mega",
		types: ["Ice", "Rock"],
		baseStats: {hp: 42, atk: 83, def: 5, spa: 94, spd: 5, spe: 100},
		abilities: {0: "Pure Power"},
		heightm: 0.8,
		weightkg: 11.4,
		color: "Blue",
