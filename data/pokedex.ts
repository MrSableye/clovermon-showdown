export const Pokedex: {[speciesid: string]: SpeciesData} = {
	...
	polybrawl: {
		...
		color: "Red",
		eggGroups: ["Ditto"],
		otherFormes: ["Polybrawl-H", "Polybrawl-W", "Polybrawl-I", "Polybrawl-P", "Polybrawl-K"],
		formeOrder: ["Polybrawl", "Polybrawl-H", "Polybrawl-W", "Polybrawl-I", "Polybrawl-P", "Polybrawl-K"],
	},
	polybrawlh: {
		num: 8203,
		name: "Polybrawl-H",
		baseSpecies: "Polybrawl",
		forme: "H",
		types: ["Electric", "Fighting"],
		gender: "N",
