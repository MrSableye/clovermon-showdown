export const Pokedex: {[speciesid: string]: SpeciesData} = {
	...
	ignifatu: {
		...
		abilities: {0: "Beast Boost", H: "Toxic Boost", S: "Sheer Force"},
		heightm: 4.21,
		weightkg: 465,
		color: "Red",
		eggGroups: ["Undiscovered"],
	...
	spenjbab: {
		...
		abilities: {0: "Beast Boost", H: "Oblivious", S: "Dry Skin"},
		heightm: 6.01,
		weightkg: 1857,
		color: "Yellow",
		eggGroups: ["Undiscovered"],
	...
	phantorney: {
		...
		abilities: {0: "Beast Boost", H: "Justified", S: "Competitive"},
		heightm: 5.18,
		weightkg: 0.2,
		color: "Blue",
		eggGroups: ["Undiscovered"],
	...
	junkgeist: {
		...
		abilities: {0: "Stench", 1: "Poison Touch", H: "Tetanus", S: "Technician"},
		heightm: 1.97,
		weightkg: 14,
		color: "Green",
		prevo: "Poltire",
	...
	skubmarine: {
		...
		abilities: {0: "Rivalry", 1: "Swift Swim", H: "Motor Drive", S: "Plus"},
		heightm: 1,
		weightkg: 18,
		color: "Yellow",
		prevo: "Skuba",
	...
	skubmarineanti: {
		...
		abilities: {0: "Rivalry", 1: "Rain Dish", H: "Motor Drive", S: "Minus"},
		heightm: 1,
		weightkg: 18,
		color: "Yellow",
		prevo: "Skuba-Anti",
	...
	noxilium: {
		...
		types: ["Ghost", "Flying"],
		genderRatio: {M: 0.5, F: 0.5},
		baseStats: {hp: 80, atk: 100, def: 69, spa: 121, spd: 64, spe: 107},
	...
	frijolero: {
		...
		types: ["Grass"],
		genderRatio: {M: 0.5, F: 0.5},
		baseStats: {hp: 65, atk: 30, def: 35, spa: 65, spd: 45, spe: 50},
	...
	platylics: {
		...
		abilities: {0: "Swift Swim", 1: "Synchronize", H: "Fairy Aura", S: "Simple"},
		heightm: 1.7,
		weightkg: 67.7,
		color: "Gray",
		prevo: "Hyduck",
	...
	impfection: {
		...
		types: ["Poison"],
		genderRatio: {M: 0.5, F: 0.5},
		baseStats: {hp: 90, atk: 85, def: 70, spa: 100, spd: 70, spe: 70},
	...
	skuba: {
		...
		abilities: {0: "Rivalry", 1: "Swift Swim", H: "Water Bubble", S: "Plus"},
		heightm: 1.0001,
		weightkg: 8.5,
		color: "Yellow",
		evos: ["Skubmarine"],
	...
	skubaanti: {
		...
		abilities: {0: "Rivalry", 1: "Rain Dish", H: "Water Bubble", S: "Minus"},
		heightm: 1.0001,
		weightkg: 8.5,
		color: "Yellow",
	...
	mogumole: {
	   ...
	   types: ["Ground", "Dragon"],
	   genderRatio: {M: 0.5, F: 0.5},
	   baseStats: {hp: 77, atk: 109, def: 70, spa: 70, spd: 68, spe: 100},
	...
	flubbster: {
	   ...
	   abilities: {0: "Damp", H: "Aftermath", S: "Guts"},
	   heightm: 1.8,
	   weightkg: 70.3,
	   color: "White",
	   evos: ["Blubbastard"],
	...
	devante: {
	 ...
	 dugwalker: {
		...
		abilities: {0: "Arena Trap", 1: "Degradation", H: "Suddenly", S: "Vessel of Ruin"},
		heightm: 3.69,
		weightkg: 13.0,
		color: "Black",
		eggGroups: ["Human-Like"],
	 ...
	 weathervein: {
		...
		abilities: {0: "Levitate", H: "Muscle Mass", S: "Flash Fire"},
		heightm: 2.7,
		weightkg: 320,
		color: "White",
		eggGroups: ["Flying", "Mineral"],
	 ...
	 tsuchinoko: {
		...
		types: ["Normal"],
		gender: "N",
		baseStats: {hp: 90, atk: 19, def: 45, spa: 10, spd: 35, spe: 6},
		abilities: {0: "Real"},
		heightm: 0.3,
		weightkg: 0.7,
		color: "Brown",
	 ...
	 kattapillar: {
		...
		types: ["Bug"],
		gender: "N",
		baseStats: {hp: 35, atk: 25, def: 45, spa: 25, spd: 15, spe: 10},
		abilities: {0: "Kattapillar's Secret Power"},
		heightm: 0.1,
		weightkg: 3.1,
		color: "Blue",
		eggGroups: ["Bug", "Field"],
	...
	blobbossexy: {
		...
		otherFormes: ["Blobbos-Sexy-Mega-Y", "Blobbos-Sexy-Mega-X"],
		formeOrder: ["Blobbos-Sexy", "Blobbos-Sexy-Mega-Y", "Blobbos-Sexy-Mega-X"],
		gen: 8,
	},
	blobbossexymegay: {
		num: 69132,
		...
		baseStats: {hp: 69, atk: 96, def: 136, spa: 34, spd: 95, spe: 135},
		abilities: {0: "Scrappy"},
		heightm: 1.3,
		weightkg: 34.3,
		color: "Blue",
	...
	blobbossexymegax: {
		num: 69132,
		name: "Blobbos-Sexy-Mega-X",
		baseSpecies: "Blobbos-Sexy",
		forme: "Mega-X",
		types: ["Dark", "Fairy"],
		baseStats: {hp: 69, atk: 34, def: 136, spa: 135, spd: 96, spe: 95},
		abilities: {0: "Degenerate"},
		heightm: 1.3,
		weightkg: 34.3,
		color: "Purple",
		eggGroups: ["Ditto"],
		requiredItem: "Sexite X",
	},
	blobbosdemifiend: {
		num: 69132,
	...
	blobboshomestuckgodtier: {
		num: 69132,
		name: "Blobbos-Homestuck-God-Tier",
		baseSpecies: "Blobbos-Homestuck",
		forme: "God-Tier",
		types: ["Dark", "Bug", "Fairy"],
		gender: "N",
		baseStats: {
			hp: 88,
			atk: 118,
	...
	blobbosmitosis: {
		...
		color: "Black",
		eggGroups: ["Undiscovered"],
		otherFormes: ["Blobbos-Mitosis-Complete"],
		formeOrder: ["Blobbos-Mitosis", "Blobbos-Mitosis-Complete"],
		gen: 8,
	},
	blobbosmitosiscomplete: {
		num: 69132,
		name: "Blobbos-Mitosis-Complete",
		baseSpecies: "Blobbos-Mitosis",
		forme: "Complete",
		types: ["Rock", "Fighting"],
		gender: "N",
		baseStats: {hp: 222, atk: 111, def: 111, spa: 66, spd: 99, spe: 111},
		abilities: {
			0: "Cell Construct",
		},
		heightm: 131.1,
		weightkg: 201848604.65,
		color: "Black",
		eggGroups: ["Undiscovered"],
	...
	emojinn: {
		...
		types: ["Psychic", "Flying"],
		gender: "M",
		baseStats: {hp: 80, atk: 45, def: 79, spa: 121, spd: 89, spe: 111},
	...
	hor: {
		...
		types: ["Normal"],
		gender: "N",
		baseStats: {hp: 90, atk: 56, def: 62, spa: 49, spd: 44, spe: 80},
		abilities: {0: "Cute Charm", H: "Quick Feet", S: "Dazzling"},
		heightm: 1.0,
		weightkg: 30,
		color: "Brown",
		eggGroups: ["Undiscovered"],
	...
	neohorse: {
		...
		types: ["Steel", "Normal"],
		gender: "N",
		baseStats: {hp: 130, atk: 100, def: 100, spa: 120, spd: 100, spe: 80},
		abilities: {0: "Full Metal Body", H: "Clear Body", S: "Filter"},
		heightm: 5.0,
		weightkg: 9999,
		color: "Gray",
		eggGroups: ["Undiscovered"],
	...
	lemonhorse: {
		...
		types: ["Grass", "Normal"],
		gender: "N",
		baseStats: {hp: 255, atk: 80, def: 65, spa: 80, spd: 65, spe: 85},
		abilities: {0: "Cud Chew", H: "Justified", S: "Drought"},
		heightm: 8.0,
		weightkg: 454,
		color: "Yellow",
		eggGroups: ["Undiscovered"],
		creator: "IF YOU CAN READ THIS SEND HELP SEND HELP SEND HELP SE",
	},
	spweedle: {
		num: -42005,
		name: "Spweedle",
	...
	jewipedeo: {
		...
		color: "Green",
		eggGroups: ["Undiscovered"],
		requiredItem: "Kikeous Orb",
		changesFrom: "Jewipede",
		gen: 9,
		tags: ["Inferior"],
	},
	buge: {
	...
	saccestoda: {
		...
		abilities: {0: "Gooey", H: "Shed Skin", S: "Regenerator"},
		heightm: 0.51,
		weightkg: 4.5,
		color: "Green",
		eggGroups: ["Water 2", "Field"],
	...
	hallmonitor: {
		...
		types: ["Normal", "Dragon"],
		genderRatio: {M: 0.5, F: 0.5},
		baseStats: {hp: 114, atk: 109, def: 68, spa: 66, spd: 52, spe: 71},
		abilities: {0: "Normalize", 1: "Unnerve", H: "Magic Bounce", S: "Stakeout"},
		heightm: 0.40,
		weightkg: 6.0,
		color: "Yellow",
		eggGroups: ["Monster", "Field"],
	...
	starhiro: {
		...
		types: ["Psychic", "Fighting"],
		genderRatio: {M: 0.5, F: 0.5},
		baseStats: {hp: 84, atk: 117, def: 76, spa: 77, spd: 58, spe: 111},
		abilities: {0: "Illuminate", 1: "Justified", H: "Lightning Rod", S: "Neuroforce"},
		heightm: 2.87,
		weightkg: 87.0,
		color: "White",
		eggGroups: ["Amorphous", "Human-Like"],
	...
	doubtlaw: {
		...
		types: ["Psychic", "Ghost"],
		genderRatio: {M: 0.5, F: 0.5},
		baseStats: {hp: 64, atk: 80, def: 86, spa: 127, spd: 68, spe: 98},
	...
	amalgum: {
		...
		types: ["Fairy", "Psychic"],
		genderRatio: {M: 0.5, F: 0.5},
		baseStats: {hp: 125, atk: 31, def: 74, spa: 134, spd: 74, spe: 20},
		abilities: {0: "Overcoat", H: "Immunity", S: "Magic Guard"},
		heightm: 3.31,
		weightkg: 100.0,
		color: "Green",
		eggGroups: ["Amorphous", "Field"],
	...
	qrakenmark: {
		...
		types: ["Water", "???"],
		genderRatio: {M: 0.5, F: 0.5},
		baseStats: {hp: 100, atk: 62, def: 68, spa: 131, spd: 103, spe: 47},
		abilities: {0: "Sticky Hold", 1: "Suction Cups", H: "Competitive", S: "Water Absorb"},
		heightm: 2.49,
		weightkg: 126.9,
		color: "Black",
		eggGroups: ["Monster", "Field"],
	...
	onusalt: {
		...
		types: ["Rock", "Normal"],
		genderRatio: {M: 0.5, F: 0.5},
		baseStats: {hp: 60, atk: 36, def: 74, spa: 64, spd: 47, spe: 34},
		abilities: {0: "Dry Skin", 1: "Rough Skin", H: "Purifying Salt", S: "Shell Armor"},
		heightm: 0.6,
		weightkg: 60.6,
		color: "Blue",
		evos: ["Ghastropod"],
	...
	ghastropod: {
		...
		types: ["Rock", "Ghost"],
		genderRatio: {M: 0.5, F: 0.5},
		baseStats: {hp: 72, atk: 61, def: 128, spa: 109, spd: 94, spe: 63},
		abilities: {0: "Dry Skin", 1: "Cursed Body", H: "Purifying Salt", S: "Weak Armor"},
		heightm: 1.8,
		weightkg: 333.3,
		color: "Purple",
		prevo: "Onusalt",
	...
	sanickel: {
		...
		types: ["Ground", "Poison"],
		genderRatio: {M: 0.5, F: 0.5},
		baseStats: {hp: 49, atk: 42, def: 101, spa: 46, spd: 40, spe: 32},
		abilities: {0: "Oblivious", 1: "Shell Armor", H: "Steelworker", S: "Immunity"},
		heightm: 0.4,
		weightkg: 3.3,
		color: "Yellow",
		evos: ["Skoxious"],
	...
	skoxious: {
		...
		types: ["Water", "Poison"],
		genderRatio: {M: 0.5, F: 0.5},
		baseStats: {hp: 79, atk: 86, def: 115, spa: 81, spd: 75, spe: 61},
		abilities: {0: "Oblivious", 1: "Iron Barbs", H: "Steelworker", S: "Poison Heal"},
		heightm: 0.9,
		weightkg: 37.2,
		color: "Yellow",
		prevo: "Sanickel",
	...
	snapuppet: {
		...
		types: ["Ghost", "Bug"],
		gender: "N",
		baseStats: {hp: 83, atk: 109, def: 137, spa: 83, spd: 97, spe: 61},
		abilities: {0: "Beast Boost", H: "Puppeteer", S: "Brainwash"},
		heightm: 2.6,
		weightkg: 99,
		color: "White",
		eggGroups: ["Undiscovered"],
	...
	popecap: {
		...
		types: ["Water", "Psychic"],
		genderRatio: {M: 0.75, F: 0.25},
		baseStats: {hp: 108, atk: 132, def: 74, spa: 68, spd: 94, spe: 51},
		abilities: {0: "Sap Sipper", 1: "Phantasma", H: "Bejeweled", S: "Beads of Ruin"},
		heightm: 1.9,
		weightkg: 121,
		color: "Green",
	...
	gunkirby: {
		...
		types: ["Fairy"],
		genderRatio: {M: 0.5, F: 0.5},
		baseStats: {hp: 80, atk: 64, def: 65, spa: 172, spd: 68, spe: 98},
		abilities: {0: "Sniper", 1: "Mega Launcher", H: "Steelworker"},
		heightm: 0.8,
		weightkg: 30,
		color: "Pink",
		eggGroups: ["Fairy"],
	...
	towhorse: {
		...
		abilities: {0: "Stamina", 1: "Rough Skin", H: "Speed Boost", S: "Solid Rock"},
		heightm: 11.9,
		weightkg: 3000,
		color: "Grey",
		eggGroups: ["Field", "Mineral"],
	...
	phantacade: {
		...
		types: ["Ghost"],
		genderRatio: {M: 0.5, F: 0.5},
		baseStats: {hp: 79, atk: 106, def: 66, spa: 83, spd: 109, spe: 51},
	...
	purplegoat: {
		...
		types: ["Normal", "Ghost"],
		genderRatio: {M: 0.5, F: 0.5},
		baseStats: {hp: 87, atk: 187, def: 97, spa: 87, spd: 83, spe: 83},
		abilities: {0: "Levitate", 1: "Shadow Tag", H: "Fluffy"},
		heightm: 1.88,
		weightkg: 198.7,
		color: "Purple",
		eggGroups: ["Monster"],
	...
	rendalopod: {
		...
		types: ["Water", "Electric"],
		genderRatio: {M: 0.5, F: 0.5},
		baseStats: {hp: 103, atk: 79, def: 68, spa: 115, spd: 85, spe: 65},
		abilities: {0: "Volt Absorb", 1: "Suction Cups", H: "Adaptability", S: "Analytic"},
		heightm: 15.28,
		weightkg: 548.97,
		color: "Blue",
		eggGroups: ["Monster", "Water 1"],
	...
	buggy: {
		...
		types: ["Bug"],
		genderRatio: {M: 0.5, F: 0.5},
		baseStats: {hp: 40, atk: 45, def: 60, spa: 40, spd: 40, spe: 70},
		abilities: {0: "Shield Dust", 1: "Lightning Rod", H: "Steelworker"},
		heightm: 0.58,
		weightkg: 18.3,
		color: "Gray",
		evos: ["Bugatti", "Bullepede"],
		eggGroups: ["Bug"],
		gen: 8,
		creator: "Zac",
	},
	bugatti: {
		...
		types: ["Bug", "Steel"],
		genderRatio: {M: 0.5, F: 0.5},
		baseStats: {hp: 70, atk: 95, def: 125, spa: 55, spd: 65, spe: 80},
		abilities: {0: "Speed Boost", 1: "Motor Drive", H: "Heavy Metal"},
		heightm: 3.41,
		weightkg: 804.3,
		color: "Gray",
		prevo: "Buggy",
	...
	bullepede: {
		...
		types: ["Bug", "Steel"],
		genderRatio: {M: 0.5, F: 0.5},
		baseStats: {hp: 100, atk: 80, def: 75, spa: 55, spd: 50, spe: 130},
		abilities: {0: "Speed Boost", 1: "Rock Head", H: "Light Metal"},
		heightm: 14.81,
		weightkg: 3075.1,
		color: "Gray",
		prevo: "Buggy",
	...
	stoppogriff: {
		...
		types: ["Flying", "Normal"],
		gender: "M",
		baseStats: {hp: 104, atk: 68, def: 76, spa: 127, spd: 87, spe: 48},
		abilities: {0: "Soundproof", H: "Dazzling"},
		heightm: 1.9,
		weightkg: 505,
		color: "Red",
		eggGroups: ["Field"],
	...
	suxako: {
		...
		abilities: {0: "Cacophony", 1: "Moody", H: "Magic Bounce", S: "Tangled Feet"},
		heightm: 1.6,
		weightkg: 16,
		color: "Green",
	...
	natuonian: { // and what the fuck is natuonian  - fiend
		num: -42513,
		name: "Natuonian",
		types: ["Ground", "Poison"],
		gender: "N",
		baseStats: {hp: 110, atk: 90, def: 70, spa: 80, spd: 125, spe: 75},
		abilities: {0: "Cacophony", 1: "Magic Bounce", H: "Moody", S: "Dry Skin"},
		heightm: 0.2,
		weightkg: 33,
		color: "Yellow",
		eggGroups: ["Undiscovered", "Flying"],
	...
	pantherk: {
		...
		types: ["Fighting", "Steel"],
		gender: "M",
		baseStats: {hp: 85, atk: 115, def: 75, spa: 105, spd: 75, spe: 100},
		abilities: {0: "Scrappy", 1: "Iron Fist", H: "Striker", S: "Immunity"},
		heightm: 1.7,
		weightkg: 81.6,
		color: "Blue",
		eggGroups: ["Human-Like", "Field"],
	...
	fungore: {
		...
		name: "Fungore",
		types: ["Psychic", "Poison"],
		baseStats: {hp: 93, atk: 71, def: 89, spa: 110, spd: 102, spe: 56},
		abilities: {0: "Effect Spore", 1: "Bloodthirsty", H: "Paralysis Heal", S: "Shroom Speed"},
		heightm: 1.3,
		weightkg: 256.7,
		color: "Yellow",
		eggGroups: ["Grass"],
	...
	glaggssacre: {
		...
		types: ["???", "???"],
		gender: "N",
		baseStats: {hp: 198, atk: 8, def: 67, spa: 180, spd: 14, spe: 45},
		abilities: {0: "Massacre"},
		heightm: 9.461e+15,
		weightkg: 4.3103e+19,
		color: "Yellow",
		eggGroups: ["Undiscovered"],
	...
	aiytch: {
		...
		name: "Aiytch",
		types: ["Normal", "???"],
		baseStats: {hp: 90, atk: 80, def: 90, spa: 110, spd: 99, spe: 111},
		abilities: {0: "H Power", 1: "Scrappy", H: "Meme Power", S: "Magic Guard"},
		heightm: 1.783,
		weightkg: 28.3,
		color: "Blue",
		eggGroups: ["Undiscovered"],
		gen: 8,
		creator: "LuffydestroyerP",
	},
	tenyuu: {
		num: 1000000,
		name: "Tenyuu",
	...
	missalts: {
		...
		name: "Missalts",
		types: ["Bird", "Psychic"],
		baseStats: {hp: 28, atk: 45, def: 25, spa: 45, spd: 25, spe: 29},
		abilities: {0: "Genwunning", 1: "Trace", H: "Telepathy", S: "Kantonaut"},
		heightm: 0.4,
		weightkg: 6.6,
		color: "Gray",
		evos: ["Missirlia"],
	...
	missirlia: {
		...
		name: "Missirlia",
		types: ["Bird", "Psychic"],
		baseStats: {hp: 38, atk: 65, def: 35, spa: 65, spd: 35, spe: 29},
		abilities: {0: "Genwunning", 1: "Trace", H: "Telepathy", S: "Kantonaut"},
		heightm: 0.8,
		weightkg: 20.2,
		color: "Gray",
	...
	missingvoir: {
		...
		name: "Missingvoir",
		types: ["Bird", "Psychic"],
		baseStats: {hp: 68, atk: 125, def: 65, spa: 125, spd: 65, spe: 29},
		abilities: {0: "Genwunning", 1: "Trace", H: "Telepathy", S: "Kantonaut"},
		heightm: 1.6,
		weightkg: 48.4,
		color: "Gray",
		...
		evoLevel: 30,
		eggGroups: ["Human-Like", "Amorphous"],
		otherFormes: ["Missingvoir-Mega"],
		formeOrder: ["Missingvoir", "Missingvoir-Mega"],
		creator: "Abel45040",
	},
	missingvoirmega: {
		num: -66282,
		name: "Missingvoir-Mega",
		baseSpecies: "Missingvoir",
		forme: "Mega",
		types: ["Bird", "Psychic"],
		baseStats: {hp: 68, atk: 185, def: 55, spa: 185, spd: 55, spe: 29},
		abilities: {0: "Phantasma"},
		heightm: 1.6,
		weightkg: 48.4,
		color: "Gray",
		eggGroups: ["Amorphous"],
		requiredItem: "Missingvoirite",
		creator: "Abel45040",
	},
	podostroud: {
		num: -42026,
	...
	graizze: {
		...
		types: ["Grass"],
		gender: "M",
		baseStats: {hp: 78, atk: 64, def: 153, spa: 96, spd: 89, spe: 23},
		abilities: {0: "Intimidate", 1: "Poison Point", H: "Earth Eater", S: "Feel The Foliage"},
		heightm: 0.1016,
		weightkg: 1.2,
		color: "Green",
		eggGroups: ["Grass"],
	...
	gardenia: {
		...
		gender: "F",
		baseStats: {hp: 100, atk: 1, def: 85, spa: 160, spd: 40, spe: 154},
	...
	unghost: {
		...
		gender: "M",
		baseStats: {hp: 100, atk: 160, def: 70, spa: 1, spd: 70, spe: 140},
	...
	fucksteel: {
		...
		gender: "M",
		baseStats: {hp: 100, atk: 160, def: 70, spa: 1, spd: 70, spe: 140},
		abilities: {0: "Armor Plate", 1: "Supreme Overlord", H: "Overeager"},
		heightm: 1.7,
		weightkg: 70,
		color: "Red",
		eggGroups: ["Fairy"],
	...
	uirapuobscuri: {
		...
		gender: "F",
		baseStats: {hp: 89, atk: 170, def: 70, spa: 1, spd: 65, spe: 145},
		abilities: {0: "Shadow Tag", 1: "Queenly Majesty", H: "Disguise"},
		heightm: 1.8,
		weightkg: 80,
		color: "Black",
		eggGroups: ["Fairy"],
